...
TARGETS := apriltag_config.h libapriltag.a libapriltag.so
...
apriltag_config.h: apriltag_config.h.in
	cat apriltag_config.h.in |sed -e "s/^#cmakedefine\(.*\)$/#define \1 1" > apriltag_config.h
